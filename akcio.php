...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-10 mt-5">
            ...
            <div id="akciok">
                <h1 style="text-align:center"><img src="img/sale.png" alt="" class="mr-2" >Akciós ajánlataink:</h1>
                <div id="sort">
                 ...
                 /* Rendezés */
                    if(isset($_GET["sort"])){
                        ...
                        switch($sort){
                            ...
                            case "price_asc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY kedvezmeny ASC";
                            break;

                            case "price_desc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY kedvezmeny DESC";
                            break;

                            case "ev_asc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY kiad_ev ASC";
                            break;

                            case "ev_desc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY kiad_ev DESC";
                            break;

                            case "szerzo_asc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY szerzo ASC";
                            break;

                            case "cim_asc":
                                $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY cim ASC";
                            break;
                        }
                    }
                        ...
                        $sql = "SELECT * FROM termekek WHERE akcio=1 ORDER BY id DESC";
                    }
